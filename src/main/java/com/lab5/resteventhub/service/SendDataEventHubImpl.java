...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("lab4doc")//namespace
                .setEventHubName("lab4doc")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://lab4doc.servicebus.windows.net/;SharedAccessKeyName=listenpolicy;SharedAccessKey=d/+wN9GDP33Jd2vy5/ErY/KAxrgqaOAhdiQhXYcXvjY=;EntityPath=lab4doc")
                /*Primary key*/
                .setSasKey("d/+wN9GDP33Jd2vy5/ErY/KAxrgqaOAhdiQhXYcXvjY=");

...
import { InterviewerComponent } from 'app/entities/interviewer/interviewer.component';
...
describe('Component Tests', () => {
  describe('Interviewer Management Component', () => {
    let comp: InterviewerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InterviewerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.interviewers && comp.interviewers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

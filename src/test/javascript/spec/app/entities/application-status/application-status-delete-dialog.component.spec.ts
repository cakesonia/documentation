...
import { ApplicationStatusDeleteDialogComponent } from 'app/entities/application-status/application-status-delete-dialog.component';
  ...
  describe('ApplicationStatus Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ApplicationStatusDeleteDialogComponent]
      })
